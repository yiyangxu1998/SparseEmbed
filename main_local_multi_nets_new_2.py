...
class Net_2(nn.Module):
    ...
    def forward(self, x, y):
        ...
        pool = nn.MaxPool2d((1,4), return_indices=True)
        unpool = nn.MaxUnpool2d((1,4))
        x_pooling, x_indices = pool(x)
        # print(x_pooling.size())
        # print(x_indices.size())
        # print(x_indices)
        x = unpool(x_pooling, x_indices)
        y_pooling, y_indices = pool(y)
        y = unpool(y_pooling, y_indices)
        # print(x.size())
        # print("")
...
parser.add_argument('--embed-dim-sparse', type=int, default=1024, metavar='N',
